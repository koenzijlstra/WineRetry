...
**ForgotpasswordActivity** is started from LoginActivity. The user enters his email address and a mail to reset
 the password is sent to the email address. This is done with the use of the sendPasswordResetEmail function, which is
